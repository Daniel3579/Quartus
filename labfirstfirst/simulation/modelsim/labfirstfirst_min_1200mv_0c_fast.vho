...
ARCHITECTURE structure OF labfirstfirst IS
...
-- Equation(s):
-- \inst7~0_combout\ = (\C~input_o\ & (\B~input_o\ $ (((\D~input_o\) # (\A~input_o\))))) # (!\C~input_o\ & (((\D~input_o\) # (\A~input_o\))))
